    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('Movies Req', url=f'https://t.me/moviereqgroup_movieshub')
                    ]
                    ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ Movies Req 🖥️', url=f'https://t.me/moviereqgroup_movieshub')
                    ]
                    ]
        ...
        await query.answer("இன்னும் கொஞ்சம் ஆர்வமாக இருக்கிறது, இல்லையா?👀",show_alert=True)
